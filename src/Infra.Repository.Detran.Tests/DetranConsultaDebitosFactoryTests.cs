...
{
    public class DetranConsultaDebitosFactoryTests : IClassFixture<DependencyInjectionFixture>
    {
        private readonly IDetranVerificadorDebitosFactory _Factory;

        public DetranConsultaDebitosFactoryTests(DependencyInjectionFixture dependencyInjectionFixture)
        {
