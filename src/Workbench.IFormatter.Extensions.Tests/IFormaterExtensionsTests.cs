...
public class IFormaterExtensionsTests
{
    ...
    [Fact(DisplayName = "Dado um Objeto que ser� serializado e deserializado utilizando o serializador 'Default' devemos ter um novo Objeto resultante igual ao original")]
